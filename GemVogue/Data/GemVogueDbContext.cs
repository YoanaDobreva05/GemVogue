        ...
        builder.Entity<Brand>()
            .HasData(
                new Brand() 
                {
                    Id = 1,
                    Name = "Pandora",
                    Description = "Магазина предлага изключителна селекция висококачествени бижута от подбрани колекции за да удовлетворим нуждите на тези, " +
                ...
                new Brand()
                {
                    ...
                    Description = "Официалните бижутата са подходящи за различни поводи, като сватби, юбилеи, балове, приеми и други." +
                ...
                new Brand()
                {
                    Id = 3,
                    Name = "Goto",
                    Description = "GOTO порасна, отвори магазин и в Испания, а с годините се превърна в наложена марка, символ на разнообразие," +
