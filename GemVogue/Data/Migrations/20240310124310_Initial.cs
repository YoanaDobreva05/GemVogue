    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "2a83ab8f-690c-48ee-9d9e-3c618b540d10", "2a83ab8f-690c-48ee-9d9e-3c618b540d10", "Administrator", "ADMINISTRATOR" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "22902e83-535b-418a-aafb-312d477c6a54", 0, "6f002996-4d2f-42e3-835c-a70dff3c636c", "admin@gemvogue.com", true, false, null, "Администратор", "ADMIN@GEMVOGUE.COM", "ADMIN@GEMVOGUE.COM", "AQAAAAIAAYagAAAAEEcfRKbJOqvw1k9Up+aiAT2neI7LLesvErL91P75D4RhBmtnRIF1ueH69COX9bMuIA==", null, false, "530f75b5-394f-4d04-a5ab-b3ac1f7d291f", false, "admin@gemvogue.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "2a83ab8f-690c-48ee-9d9e-3c618b540d10", "22902e83-535b-418a-aafb-312d477c6a54" });

            migrationBuilder.InsertData(
                table: "Jewelry",
                columns: new[] { "Id", "BrandId", "CreatedOn", "Description", "Image", "Material", "Name", "Type" },
                values: new object[,]
                {
                    { 1, 3, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3711), "Сребърно колие с Феникс.Феникса е символ на унищожаване на старият и начало на новият по-добър живот.Размер на синджира: с регулиране от 42 до 45 смРазмер на феникса: 22x20 мм", "\\Images\\kolie-feniks.jpg", "Материал: Сребро, Камъни: кристали цирконийКарат: 925.0", "Колие Феникс", 1 },
                    { 2, 1, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3717), "Сребърен пръстен с изключително рядка зелена разновидност на скъпоценният камък Аметист.Произход на камъка Бразилия.Вярва се, че бижутата от аметист помагат на притежателя си да очарова хората около себе си, като засилва харизматичното му излъчване.Размер на камъка: 8x6 мм, 2,3 cм", "\\Images\\prsten-ss-zelen-ametist.jpg", "Материал: СреброКамъни: скъпоценен камък зелен АметистКарат: 925.0", "Пръстен със зелен аметист", 2 },
                    { 3, 1, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3722), "Гривна Pandora Moments Звездопад.Този продукт е съвместим само с модели от колекция Pandora MomentsКарат: 925.0", "\\Images\\grivna-zvezdopdad.png", "Материал :СреброКамъни: Кубичен цирконий, КристалКарат: 925.0", "Гривна Звездопад", 3 },
                    { 4, 1, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3727), "Обеци Game of Thrones x Pandora Домът на дракона", "\\Images\\domut-na-drakona.png", "Материал :СреброКамъни:КристалКарат: 925.0", " Домът на дракона", 4 },
                    { 5, 2, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3731), "Дамски сребърен пръстен с 18К бяла позлата и създадени диаманти и сапфир.", "\\Images\\srebaren-prusten-sudadenid-sapfir.jpeg", "Материал:СреброКамъни: Създаден диамант, Създадени Скъпоценни Камъни.Карат: 925.0", "Сребърен пръстен с диаманти от сапфир", 2 },
                    { 6, 1, new DateTime(2024, 3, 10, 14, 43, 8, 377, DateTimeKind.Local).AddTicks(3735), " Сребърна дамска гривна за крак-класически стил.", "\\Images\\damska-grivna-za-krak.jpeg", "Материал: СреброКарат: 925.0", "Дамска гривна за крак", 3 }
                });
